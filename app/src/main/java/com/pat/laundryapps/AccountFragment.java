...
public class AccountFragment extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tv1 = (TextView) view.findViewById(R.id.tvUser);
        tv2 = (TextView) view.findViewById(R.id.tvAdd);
        b1 = (Button) view.findViewById(R.id.blogout2);
        b2 = (Button) view.findViewById(R.id.bcall);
    ...
    public void getData(){
        ...
        if(c.moveToFirst()) {
            ...
            if(dataget != null) {
                ...
                myadd = c.getString(3);
                tv1.setText(String.valueOf(myname));
                tv1.setVisibility(View.VISIBLE);
                tv2.setText(String.valueOf(myadd));
